...
namespace MarkTheSpot
{
    public partial class App : Application
    {
        ...
        {
            m_mustClearPagestack = CheckDeactivationTimeStamp();
        ...
        public void SaveCurrentDeactivationSettings()
        {
            ...
            if (AddOrUpdateValue("SessionType", m_sessionType))
            {
                settings.Save();
            }
        }
        ...
        void RestoreSessionType()
        {
            ...
            {
                m_sessionType = (SessionType)settings["SessionType"];
            }
        }
        ...
        {
            if (m_sessionType == SessionType.None && e.NavigationMode == NavigationMode.New)
            {
                ...
                {
                    m_sessionType = SessionType.DeepLink;
                }
                else if (e.Uri.ToString().Contains("/MainPage.xaml"))
                {
                    m_sessionType = SessionType.Home;
                }
            }
            ...
            if (e.NavigationMode == NavigationMode.Reset)
            {
                ...
                m_wasRelaunched = true;
            }
            else if (e.NavigationMode == NavigationMode.New && m_wasRelaunched)
            {
                // This block will run if the previous navigation was a relaunch
                m_wasRelaunched = false;
                ...
                else if (e.Uri.ToString().Contains("/MainPage.xaml"))
                {
                    ...
                    if (m_sessionType == SessionType.DeepLink)
                    {
